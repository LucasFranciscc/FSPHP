...
if (strpos(url(), "localhost")) {
    ...
    $minCSS->add(__DIR__ . "/../../../shared/app/styles/styles.css");
    $minCSS->add(__DIR__ . "/../../../shared/app/styles/boot.css");
    ...
    $minJS->add(__DIR__ . "/../../../shared/app/scripts/jquery.mask.js");
    $minJS->add(__DIR__ . "/../../../shared/app/scripts/highcharts.js");
